...
namespace MustardBlack.ViewEngines.Razor
{
	...
	public class CompilationFailedException : Exception, ICompilationException
	{
		...
		{
			return "Resources.CompilationFailed" + Environment.NewLine + string.Join(Environment.NewLine, compilationFailures.SelectMany(f => f.Messages).Select(message => message.FormattedMessage));
		}
	}
}